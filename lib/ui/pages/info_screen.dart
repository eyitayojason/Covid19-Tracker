                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    PreventCard(
                      ...
                      text:
                          "Since the start of the Coronavirus Pandemic, the world have fully embraced the wearing of facemasks",
                    ),
                    PreventCard(
...
class SymptopCard extends StatelessWidget {
  ...
  final String title;
  final bool isActive;
  const SymptopCard({Key key, this.image, this.title, this.isActive = false}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(borderRadius: BorderRadius.circular(15), color: Colors.white, boxShadow: [
        isActive
            ? BoxShadow(offset: Offset(0, 10), blurRadius: 20, color: kActiveShadowColor)
